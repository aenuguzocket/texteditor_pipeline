"""
Layered Pipeline with Qwen + CRAFT + Gemini (Cost Estimate Variant)
===================================================================
1. CRAFT: Detect text regions
2. Gemini: Classify regions (Keep vs Remove) - USES COST TRACKING MODULE
...
# CHANGED: Import from the cost-aware playground module
from test_text_analysis_playground import analyze_text_crops_batch 
...
def run_pipeline_layered():
    # HARDCODED INPUTS
    IMAGE_PATH = "image/t3.png"
    MOCK_LAYERS_DIR = "outputs/layerst3"
    ...
    print(f"Starting LAYERED PIPELINE (TEST COST VARIANT) for: {image_path.name}")
    ...
    # STEP 2: Gemini
    # ------------------------------------------------------------------
    print("\n[STEP 2] Running Gemini Analysis (With Cost Estimation)...")
