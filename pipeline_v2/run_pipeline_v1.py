...
# -----------------------------------------------------------------------------
try:
    from run_pipeline_box_detection import run_box_detection_pipeline
    from run_pipeline_text_rendering import (
        composite_layers, 
    ...
    print("Ensure run_pipeline_box_detection.py and run_pipeline_text_rendering.py are in the same directory.")
    sys.exit(1)
...
def run_pipeline_v1(run_dir: str):
    """
    ...
    print(f"\n************************************************************")
    print(f"STARTING COMBINED PIPELINE V1")
