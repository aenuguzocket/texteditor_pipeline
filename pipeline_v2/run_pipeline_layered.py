...
def create_removable_mask(image_shape, craft_result, gemini_results):
    ...
    for region in craft_result["text_regions"]:
        ...
        if role in ["product_text", "logo", "label"]:
            continue
        ...
        for local_region in layer_result["text_regions"]:
            ...
            for global_region in global_craft_result["text_regions"]:
                ...
                if x_right > x_left and y_bottom > y_top:
                    ...
                    if role in ["product_text", "ui_element", "logo", "label"]:
                        is_protected = True
                ...
                if (gx_pad <= cx <= gx_pad + gw_pad and
                    ...
                    if role not in ["product_text", "ui_element", "logo", "label"]:
...
def run_pipeline_layered():
    ...
    final_report = {
        "input_image": str(image_path), # Save full path to ensure downstream steps can find it
        "original_size": {
